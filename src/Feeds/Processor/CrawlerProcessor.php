...
namespace Drupal\feeds_crawler\Feeds\Processor;
 ...
 *   description = @Translation("Creates entities of any type by crawling sources on the internet."),
 *   arguments = {"@entity_type.manager", "@entity.query", "@entity_type.bundle.info"},
 *   form = {
 *     "configuration" = "Drupal\feeds_crawler\Feeds\Processor\Form\DefaultEntityProcessorForm",
 *     "option" = "Drupal\feeds_crawler\Feeds\Processor\Form\EntityProcessorOptionForm",
 *   },
 * )
 */
class CrawlerProcessor extends EntityProcessorBase implements EntityProcessorInterface {
  ...
  public function __construct(array $configuration, $plugin_id, array $plugin_definition, EntityTypeManagerInterface $entity_type_manager, QueryFactory $query_factory, EntityTypeBundleInfoInterface $entity_type_bundle_info) {
    $plugin_definition['entity_type'] = $this->entityType();
